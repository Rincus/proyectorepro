...
Launch the [`make.R`](https://github.com/Rincus/proyectorepro/tree/main/make.R)
file with:
...
check out our [Contributor Guidelines](https://github.com/Rincus/proyectorepro/blob/main/CONTRIBUTING.md).
