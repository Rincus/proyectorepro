...
[Contributor Code of Conduct](https://github.com/Rincus/proyectorepro/blob/main/CODE_OF_CONDUCT.md).
By participating, you are expected to uphold this code. Please report 
unacceptable behavior to <fmvaldebenito@uc.cl>.
...
[Issues](https://github.com/Rincus/proyectorepro/issues) that might help 
...
- Open a new [Issue](https://github.com/Rincus/proyectorepro/issues/new).
- Use the template [other_issue.md](https://github.com/Rincus/proyectorepro/blob/main/.github/ISSUE_TEMPLATE/other_issue.md).
...
for your bug or error in the [bug tracker](https://github.com/Rincus/proyectorepro/issues?q=label%3Abug).



### How do I submit a bug report?

We use [GitHub Issues](https://github.com/Rincus/proyectorepro/issues) to 
track bugs and errors. If you run into an issue with the project:

- Open a new [Issue](https://github.com/Rincus/proyectorepro/issues/new).
- Use the template [bug_report.md](https://github.com/Rincus/proyectorepro/blob/main/.github/ISSUE_TEMPLATE/bug_report.md).
...
- Make sure that you are using the latest version of `proyectorepro`.
- Read the [documentation](https://github.com/Rincus/proyectorepro/)
carefully and find out if the functionality is already covered.
- Perform a [search](https://github.com/Rincus/proyectorepro/issues) to 
...
[GitHub Issues](https://github.com/Rincus/proyectorepro/issues).

- Open a new [Issue](https://github.com/Rincus/proyectorepro/issues/new).
- Use the template [feature_request.md](https://github.com/Rincus/proyectorepro/blob/main/.github/ISSUE_TEMPLATE/feature_request.md).
...
3. Submit a [Pull Request](https://docs.github.com/en/get-started/quickstart/contributing-to-projects#making-a-pull-request) on the [original repo](https://github.com/Rincus/proyectorepro/compare).
